build:
	g++ -O3 -shared -std=c++11 -undefined dynamic_lookup `python3 -m pybind11 --includes` universe.cpp ../nbody/nbody.cpp -o astrosim`python3-config --extension-suffix` -D PYTHON
